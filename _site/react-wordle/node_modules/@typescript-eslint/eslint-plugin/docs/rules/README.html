<p><code class="language-plaintext highlighter-rouge">@typescript-eslint/eslint-plugin</code> comes with two rulesets you can extend from to pull in the recommended starting rules:</p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Requires that private members are marked as <code class="language-plaintext highlighter-rouge">readonly</code> if they’re never modified outside of the constructor</td>
      <td> </td>
      <td>:wrench:</td>
      <td>:thought_balloon:</td>
    </tr>
...
<p>In some cases, ESLint provides a rule itself, but it doesn’t support TypeScript syntax; either it crashes, or it ignores the syntax, or it falsely reports against it.
